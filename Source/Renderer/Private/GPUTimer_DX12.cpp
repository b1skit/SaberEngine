...
#include "Private/Device_DX12.h"
#include "Private/GPUTimer_DX12.h"
...
namespace dx12
{
		...
		re::GPUTimer const& timer, re::GPUTimer::TimerType timerType)
	{
		...
		{
			cmdQueue = &re::RenderManager::Get()->GetContext()->As<dx12::Context*>()->GetCommandQueue(
