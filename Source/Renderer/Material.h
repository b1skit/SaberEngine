...
namespace gr
{
	...
	public:
		...
		struct MaterialInstanceRenderData final
		{
			...
			static re::AccelerationStructure::InclusionMask CreateInstanceInclusionMask(gr::Material::MaterialInstanceRenderData const&);

			// Helper: Create material-specific BLAS AccelerationStructure::InstanceFlags
			static re::AccelerationStructure::InstanceFlags CreateInstanceFlags(
