...
namespace opengl
{
	...
	public:
		...
		static uint64_t ComputeVAOHash(re::VertexBufferInput const*, re::VertexBufferInput const& indexStream);

		GLuint GetCreateVAO(re::VertexBufferInput const*, re::VertexBufferInput const& indexStream);
