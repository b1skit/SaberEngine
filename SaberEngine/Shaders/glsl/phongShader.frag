...
{	
	...
	vec4 MatRMAO			= texture(MatRMAO, data.uv0.xy);
	...
	// Specular:	
	vec4 specContribution		= vec4( PhongSpecular(data.worldPos, worldNormal, keylightWorldDir, lightColor, in_view, MatRMAO.r, MatProperty0.a) * FragColor.xyz, 1);
