...
namespace gr
{
	...
	public:
		...
		void AddPermanentParameterBlock(re::ParameterBlock::Handle pb);
		inline std::vector<re::ParameterBlock::Handle> const& GetPermanentParameterBlocks() const { return m_permanentParamBlocks; }

		void AddPerFrameParameterBlock(re::ParameterBlock::Handle pb);
		inline std::vector<re::ParameterBlock::Handle> const& GetPerFrameParameterBlocks() const { return m_perFrameParamBlocks; }
	...
	private:
		...
		std::vector<re::ParameterBlock::Handle> m_perFrameParamBlocks;
		std::vector<re::ParameterBlock::Handle> m_permanentParamBlocks;
