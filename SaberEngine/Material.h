...
namespace gr
{
	...
	public:
		...
		inline std::shared_ptr<re::ParameterBlock>& GetMatParams() { return m_matParams; }
		inline std::shared_ptr<re::ParameterBlock const> const GetMatParams() const { return m_matParams; }
